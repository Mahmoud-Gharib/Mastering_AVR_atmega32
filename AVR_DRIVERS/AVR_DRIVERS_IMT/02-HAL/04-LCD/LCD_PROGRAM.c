...
{
	MDIO_voidSetPinDirection(LCD_DATA_PORT,LCD_EN_PIN,DIO_u8_OUTPUT);
	MDIO_voidSetPinDirection(LCD_DATA_PORT,LCD_RS_PIN,DIO_u8_OUTPUT);
	...
	MDIO_voidSetPinDirection(DIO_u8_PORTD,LCD_DATA_PIN_4,DIO_u8_OUTPUT);
	MDIO_voidSetPinDirection(DIO_u8_PORTD,LCD_DATA_PIN_5,DIO_u8_OUTPUT);
	MDIO_voidSetPinDirection(DIO_u8_PORTD,LCD_DATA_PIN_6,DIO_u8_OUTPUT);
	MDIO_voidSetPinDirection(DIO_u8_PORTD,LCD_DATA_PIN_7,DIO_u8_OUTPUT);
	_delay_ms(100);
...
{
	#if (LCD_MODE == _8_BIT_MODE)
	MDIO_voidSetPinValue (LCD_DATA_PORT,LCD_RS_PIN,DIO_u8_LOW);
	MDIO_voidSetPortValue(LCD_DATA_PORT,Copy_u8Cmd);
	MDIO_voidSetPinValue (LCD_DATA_PORT,LCD_EN_PIN,DIO_u8_HIGH);
	_delay_ms(1);
	MDIO_voidSetPinValue(LCD_DATA_PORT,LCD_EN_PIN,DIO_u8_LOW);
	_delay_ms(5);
	...
	MDIO_voidSetPinValue(LCD_DATA_PORT,LCD_EN_PIN,DIO_u8_HIGH); //EN
	_delay_ms(1);
	MDIO_voidSetPinValue(LCD_DATA_PORT,LCD_EN_PIN,DIO_u8_LOW);
...
{
	#if (LCD_MODE == _8_BIT_MODE)
	MDIO_voidSetPinValue (LCD_DATA_PORT,LCD_RS_PIN,DIO_u8_HIGH);
